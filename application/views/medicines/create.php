...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    <div>
        <div class="flex items-center gap-2 mb-1">
            ...
            <h2 class="text-2xl font-bold text-slate-900 mb-0">Create New Medicine</h2>
        </div>
        <p class="text-xs sm:text-sm text-slate-500 mb-0">Add a new pharmaceutical product to the inventory catalog.</p>
    </div>
    <div class="flex items-center gap-2.5">
        ...
        <button type="submit" form="createMedicineForm" class="btn btn-emerald text-xs sm:text-sm font-semibold rounded-xl px-5 py-2.5 shadow-md shadow-emerald-600/20 hover:shadow-lg transition flex items-center gap-2">
...
<form action="<?php echo base_url('medicines/store'); ?>" method="POST" id="createMedicineForm" class="needs-validation" novalidate>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        
        <!-- LEFT 2 COLS: PRIMARY MEDICINE ATTRIBUTES -->
            ...
            <div class="app-card p-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" 
                               name="medicine_name" 
                               id="medicine_name" 
                               value="<?php echo set_value('medicine_name'); ?>" 
                        ...
                        <select name="category_id" id="category_id" class="form-select text-sm rounded-xl border-slate-200 focus:border-emerald-500 <?php echo form_error('category_id') ? 'is-invalid' : ''; ?>" required>
                            ...
                            <?php if (isset($categories) && !empty($categories)): ?>
                                <?php foreach ($categories as $cat): ?>
                                    <option value="<?php echo $cat['id']; ?>" <?php echo (set_value('category_id') == $cat['id']) ? 'selected' : ''; ?>>
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" 
                                   ...
                                   name="price" 
                                   id="price" 
                                   value="<?php echo set_value('price', '12.50'); ?>" 
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               name="stock_quantity" 
                               id="stock_quantity" 
                               value="<?php echo set_value('stock_quantity', '100'); ?>" 
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Clinical uses, dosage instructions, or warehouse notes..."><?php echo set_value('description'); ?></textarea>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="app-card p-5 sm:p-6">
                ...
                <div class="space-y-4">
                    <!-- 7. Expiry Date (Cannot be in the past) -->
                    <div>
                        ...
                        <input type="date" 
                               ...
                               value="<?php echo set_value('expiry_date', date('Y-m-d', strtotime('+1 year'))); ?>" 
                               ...
                               required>
                        <p class="text-[11px] text-slate-400 mt-1 mb-0">Cannot be in the past for new medicines.</p>
                        <div class="invalid-feedback text-xs">Please select a valid future expiry date.</div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="image_url" 
                               id="image_url" 
                               value="<?php echo set_value('image_url', 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300&auto=format&fit=crop&q=80'); ?>" 
                               class="form-control text-sm rounded-xl border-slate-200 focus:border-emerald-500" 
                               placeholder="https://..." 
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="form-select text-sm rounded-xl border-slate-200 focus:border-emerald-500">
                            <option value="active" <?php echo (set_value('status', 'active') === 'active') ? 'selected' : ''; ?>>Active</option>
